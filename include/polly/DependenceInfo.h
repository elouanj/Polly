...
struct Dependences {
  ...
  /// Print the stored dependence information in DiscoPoP format.
  void printDependenciesDiscoPoP(llvm::raw_ostream &OS, Scop &S);

  void finalPrint(int kind, std::string type, llvm::raw_ostream &OS);
